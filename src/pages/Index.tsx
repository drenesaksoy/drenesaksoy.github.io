...
import smileBg from '@/assets/smile-closeup.jpg';
...
const translations: Translation = {
  ...
  // Hero section
  welcomeTitle: { tr: 'Dr. Enes Aksoy', en: 'Dr. Enes Aksoy', ar: 'د. إينيس أقصوي' },
  welcomeSubtitle: { tr: 'Gülüşünüzün Mimarı - Modern Diş Hekimliği', en: 'Architect of Your Smile - Modern Dentistry', ar: 'مهندس ابتسامتك - طب الأسنان الحديث' },
...
const DentalClinic = () => {
  ...
  const testimonials = [
    { name: 'Ayşe Kaya', text: 'Harika bir deneyimdi, çok memnun kaldım!', rating: 5 },
    { name: 'Mehmet Demir', text: 'Profesyonel hizmet, kesinlikle tavsiye ederim.', rating: 5 },
    { name: 'Fatma Özkan', text: 'Çok nazik ve anlayışlı bir doktor.', rating: 5 }
  ];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-2xl font-bold text-primary">Dr. Enes Aksoy</div>
            </div>
            
            {/* Desktop Navigation */}
            <nav className="hidden lg:flex items-center space-x-8">
              {['home', 'about', 'services', 'hygiene', 'cases', 'contact'].map((section) => (
                <button
                  key={section}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button 
                ...
                onClick={() => window.open('https://www.instagram.com/drenesaksoy/', '_blank')}
              >
              ...
              <Button 
                ...
                onClick={() => window.open('mailto:info@drenesaksoy.com', '_blank')}
              >
                ...
                return (
                  <Card 
                    ...
                    className={`medical-card cursor-pointer transition-luxury duration-500 overflow-hidden ${
                      isExpanded ? 'ring-2 ring-primary/20 shadow-luxury' : 'hover:scale-105'
                    }`}
                  ...
                  >
                    <CardContent className="p-8">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-4">
                          <div className={`p-3 rounded-full transition-luxury ${
                            isExpanded ? 'bg-primary text-primary-foreground shadow-luxury' : 'bg-primary/10'
                          }`}>
                            <IconComponent className={`h-8 w-8 transition-luxury ${
                              isExpanded ? 'text-primary-foreground scale-110' : 'text-primary'
                            }`} />
                          </div>
                  ...
                  <CardContent className="p-0">
                    ...
                    <ul className="space-y-3 text-foreground">
                      <li className="flex items-start gap-2">
                        ...
                        <span><strong>Günde 2 kez</strong> fluorürlü diş macunu ile en az 2 dakika fırçalayın</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Diş ipi</strong> kullanarak dişleriniz arasındaki plakları temizleyin</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Antibakteriyel gargara</strong> ile ağzınızı çalkalayın</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>6 ayda bir</strong> diş hekimi kontrolü yaptırın</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="medical-card p-6">
                  <CardContent className="p-0">
                    ...
                    <ul className="space-y-3 text-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Şekerli ve asitli</strong> yiyecekleri sınırlayın</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Günde 8-10 bardak su</strong> tüketerek ağzınızı nemli tutun</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Kalsiyum ve vitamin D</strong> açısından zengin besinler tüketin</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Sigara ve alkol</strong> tüketiminden kaçının</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="medical-card p-6">
                  <CardContent className="p-0">
                    ...
                    <ul className="space-y-3 text-foreground">
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Elektrikli fırça:</strong> Daha etkili plak temizliği, zamanlayıcı özelliği</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Manuel fırça:</strong> Yumuşak kıllar, küçük başlık tercih edin</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>3 ayda bir</strong> diş fırçanızı değiştirin</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                        <span><strong>Doğru teknik:</strong> Dairesel hareketlerle nazikçe fırçalayın</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="medical-card text-center">
                  <CardContent className="p-8 flex flex-col items-center justify-center h-full">
                    ...
                    <h3 className="font-bold text-primary mb-2 text-lg">{t('phone')}</h3>
                    <a 
                ...
                <Card className="medical-card text-center">
                  <CardContent className="p-8 flex flex-col items-center justify-center h-full">
                    ...
                    <h3 className="font-bold text-primary mb-2 text-lg">{t('email')}</h3>
                    <a 
                ...
                <Card className="medical-card text-center">
                  <CardContent className="p-8 flex flex-col items-center justify-center h-full">
                    ...
                    <h3 className="font-bold text-primary mb-3 text-lg">{t('address')}</h3>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex justify-center gap-6 mb-4">
              <a href="tel:+905411543686" className="hover:text-primary-light transition-smooth">
                <Phone size={20} />
              </a>
              <a href="mailto:info@drenesaksoy.com" className="hover:text-primary-light transition-smooth">
                <Mail size={20} />
              </a>
              <a href="https://wa.me/905411543686" target="_blank" rel="noopener noreferrer" className="hover:text-primary-light transition-smooth">
                <MessageCircle size={20} />
              </a>
              <a href="https://www.instagram.com/drenesaksoy/" target="_blank" rel="noopener noreferrer" className="hover:text-primary-light transition-smooth">
                <Instagram size={20} />
              </a>
            </div>
